...
type ActiveTab = "overview" | "videos" | "playlists" | "activity" | "achievements" | "levels";
  ...
  return (
    <section className="mx-auto w-full max-w-[1240px] space-y-4 sm:-mt-6">
      ...
      <nav className="mx-auto flex w-full max-w-[1050px] flex-wrap gap-2">
        ...
        <Link href={`/profile/${handle}/achievements`} className={tabClass(activeTab === "achievements")}>
         Ачивки
        </Link>
        <Link href={`/profile/${handle}/levels`} className={tabClass(activeTab === "levels")}>
         Рівні каналу
       </Link>
      </nav>
