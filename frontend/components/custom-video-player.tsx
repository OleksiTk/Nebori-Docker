...
type CustomVideoPlayerProps = {
  ...
  hlsUrls?: Record<string, string>; // { "1080p": "url", "720p": "url" }
};
...
function PlayIcon() {
  return (
    <svg viewBox="0 0 16 16" className="h-4 w-4" aria-hidden="true">
      <path
        d="M4 2.8v10.4c0 .6.7 1 1.2.7l8.1-5.2a.8.8 0 0 0 0-1.4L5.2 2.1A.8.8 0 0 0 4 2.8z"
        fill="currentColor"
      />
    </svg>
  );
...
function VolumeIcon({ muted }: { muted: boolean }) {
  return muted ? (
    <svg viewBox="0 0 16 16" className="h-4 w-4" aria-hidden="true">
      <path
        d="M2.5 6.3h2.3l2.8-2.4c.5-.4 1.2 0 1.2.6v7c0 .6-.7 1-1.2.6L4.8 9.7H2.5z"
        fill="currentColor"
      />
      <path
        d="m10.4 6.2 3.1 3.1m0-3.1-3.1 3.1"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
      />
    ...
    <svg viewBox="0 0 16 16" className="h-4 w-4" aria-hidden="true">
      ...
      />
      <path
        d="M11 6.1c.7.6.7 3.2 0 3.8m1.7-5.2c1.2 1.2 1.2 5.4 0 6.6"
        stroke="currentColor"
        strokeWidth="1.1"
        strokeLinecap="round"
      />
...
function StepBackIcon() {
  return (
    <svg viewBox="0 0 16 16" className="h-4 w-4" aria-hidden="true">
      ...
      <path
        d="M13 3.4v9.2c0 .5-.6.9-1.1.6L5.1 8.6a.7.7 0 0 1 0-1.2l6.8-4.6c.5-.3 1.1 0 1.1.6z"
        fill="currentColor"
      />
    </svg>
  );
...
export function CustomVideoPlayer({
  ...
  useEffect(() => {
    ...
    if (src.includes(".m3u8")) {
      if (Hls.isSupported()) {
        ...
        console.error("HLS не підтримується цим браузером");
      }
    } else {
      video.src = src;
    }
  ...
  const togglePlay = async () => {
    ...
    try {
      if (video.paused) {
        // Чекаємо поки відео готове до відтворення
      ...
      // AbortError — ігноруємо, це нормально при швидких кліках
  ...
  return (
    <div
      ref={wrapRef}
      className="relative aspect-video overflow-hidden rounded-[4px] border border-[rgba(255,255,255,0.14)] bg-black"
    >
      <video
        ref={videoRef}
        ...
        <div className="pointer-events-auto relative">
          <div className="grid grid-cols-[auto_1fr_auto] items-center gap-2 rounded-[2px] border border-[rgba(255,255,255,0.2)] bg-[linear-gradient(180deg,#2a303d_0%,#1b202a_100%)] px-2 py-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.18)]">
            ...
            <div className="flex min-w-0 items-center gap-2">
              ...
              >
                ...
                <div
                  ...
                  style={{
                    left: `calc(${seeking ? seekValue : progress}% - 5px)`,
                  }}
                />
              </div>
            ...
            <div className="flex items-center gap-1">
              ...
              <input
                ...
                style={{
                  ["--progress" as any]: `${(muted ? 0 : volume) * 100}%`,
                }}
          ...
          {settingsOpen && (
            <div className="absolute bottom-11 right-0 w-44 rounded-[2px] border border-[rgba(255,255,255,0.18)] bg-[rgba(10,12,18,0.96)] p-2 text-xs text-white">
              <div className="mb-1 font-semibold text-[#d6dbe8]">
                Налаштування
              </div>
                  ...
                  <button
                    ...
                    className={`rounded-[2px] border px-1.5 py-1 ${
                      playbackRate === rate
                        ...
                        : "border-[rgba(255,255,255,0.2)] text-[#d0d7e7]"
                    }`}
                  >
                    {rate}x
                  </button>
